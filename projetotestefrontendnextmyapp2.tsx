    ...
    <div className="min-h-screen bg-white text-neutral-800">
      ...
      <section className="px-6 mt-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            { name: "Vibes nerd style", price: "R$ 250", img: "/glasses1.png" },
            { name: "Para poucos", price: "R$ 250", img: "/glasses2.png" },
            { name: "Gatinha da noite", price: "R$ 270", img: "/glasses3.png" },
          ].map((item, i) => (
            <div key={i} className="border p-4 rounded-xl text-center">
              <Image
                src={item.img}
                alt={item.name}
                width={150}
      ...
      <section className="bg-[#D5F2EF] px-6 py-12">
        <h3 className="text-2xl font-semibold text-center mb-8">Categories</h3>
